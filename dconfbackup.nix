...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/notifications" = {
      application-children = [ "org-gnome-settings" "gnome-power-panel" "org-gnome-console" "org-gnome-characters" "firefox" "org-gnome-nautilus" "gnome-network-panel" "org-gnome-extensions" "impress" "writer" "org-gnome-tweaks" "code" "teams" "org-gnome-terminal" "io-github-realmazharhussain-gdmsettings" "org-gnome-gedit" "xdg-desktop-portal-gnome" "vlc" "gnome-system-monitor" "org-keepassxc-keepassxc" ];
    };
    ...
    "org/gnome/evince/default" = {
      window-ratio = mkTuple [ 1.7254901960784315 1.1098484848484849 ];
    };
    ...
    "org/gnome/gedit/plugins/filebrowser" = {
      root = "file:///";
      tree-view = true;
      virtual-root = "file:///sys/class/leds/platform::kbd_backlight/device/power";
    };
    ...
    "org/gnome/software" = {
      check-timestamp = mkInt64 1694356673;
      first-run = false;
    };
    ...
    "org/gtk/settings/color-chooser" = {
      custom-colors = [ (mkTuple [ 0.10333333333333335 0.10333333333333335 ]) (mkTuple [ 0.7490196078431373 0.13725490196078433 ]) (mkTuple [ 7.058823529411765e-2 7.058823529411765e-2 ]) (mkTuple [ 7.0e-2 7.0e-2 ]) (mkTuple [ 0.8 0.8 ]) (mkTuple [ 0.9372549019607843 0.9411764705882353 ]) (mkTuple [ 6.666666666666667e-2 6.666666666666667e-2 ]) (mkTuple [ 9.411764705882353e-2 9.411764705882353e-2 ]) ];
