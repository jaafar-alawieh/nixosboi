...
#      shellInit 
	...
	cbbb = "cd ../../..";
	cbbbb = "cd ../../../.."; 
	ppt2pdf = "soffice --headless --convert-to pdf ";
	dconfdump = "dconf dump / | dconf2nix > dconf.nix ; sudo cp dconf.nix /etc/nixos/dconf.nix";
	dconfdumphalf = "dconf dump / | dconf2nix > dconf.nix ";
